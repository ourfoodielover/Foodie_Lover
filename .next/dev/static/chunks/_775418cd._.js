...
function KitchenPage() {
    ...
    const [tick, setTick] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0); // increments every second for live timers
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "KitchenPage.useEffect": ()=>{
            ...
            const t2 = setInterval({
                "KitchenPage.useEffect.t2": ()=>{
                    setClock(new Date().toLocaleTimeString());
                    setTick({
                        "KitchenPage.useEffect.t2": (n)=>n + 1
                    }["KitchenPage.useEffect.t2"]); // forces re-render for live MM:SS timers
                }
...
_s(KitchenPage, "PDozeUnjDY4grS308NurBcltGEI=", false, function() {
    return [
